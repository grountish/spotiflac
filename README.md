...
To build a native macOS `.app` bundle from this repo:
...
If the global `wails` CLI is not installed, the script falls back to:

```bash
go run github.com/wailsapp/wails/v2/cmd/wails@v2.12.0
```
