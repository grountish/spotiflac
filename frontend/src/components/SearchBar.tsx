...
interface SearchBarProps {
    ...
    historyCheckingPlayableIds?: Set<string>;
    historyCurrentPlayableId?: string | null;
    historyIsCurrentPlayablePlaying?: boolean;
    historyPlayableIds?: Set<string>;
    history: HistoryItem[];
    onHistoryPlay?: (item: HistoryItem) => void;
    onHistoryResolvePlayable?: (item: HistoryItem) => void;
...
export function SearchBar({
    ...
    onFetch,
    onFetchUrl,
    historyCheckingPlayableIds,
    historyCurrentPlayableId,
    historyIsCurrentPlayablePlaying,
    historyPlayableIds,
    history,
    onHistoryPlay,
    onHistoryResolvePlayable,
    onHistorySelect,
    onHistoryRemove,
    hasResult,
    searchMode,
    ...
    return (<div className="space-y-4">
      ...
      {!searchMode && !hasResult && (<FetchHistory history={history} checkingPlayableIds={historyCheckingPlayableIds} currentPlayableId={historyCurrentPlayableId} isCurrentPlayablePlaying={historyIsCurrentPlayablePlaying} playableIds={historyPlayableIds} onPlay={onHistoryPlay} onResolvePlayable={onHistoryResolvePlayable} onSelect={onHistorySelect} onRemove={onHistoryRemove}/>)}
