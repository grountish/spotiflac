...
export function PlaylistInfo({ playlistInfo, trackList, searchQuery, sortBy, selectedTracks, downloadedTracks, failedTracks, skippedTracks, downloadingTrack, isDownloading, bulkDownloadType, downloadProgress, currentDownloadInfo, currentPage, itemsPerPage, downloadedLyrics, failedLyrics, skippedLyrics, downloadingLyricsTrack, checkingAvailabilityTrack, availabilityMap, downloadedCovers, failedCovers, skippedCovers, downloadingCoverTrack, isBulkDownloadingCovers, isBulkDownloadingLyrics, isMetadataLoading = false, sharedLocalPlayer, onSearchChange, onSortChange, onToggleTrack, onToggleSelectAll, onDownloadTrack, onDownloadSoulseekTrack, onDownloadLyrics, onDownloadCover, onCheckAvailability, onDownloadAllLyrics, onDownloadAllCovers, onDownloadAll, onDownloadSelected, onStopDownload, onOpenFolder, onPageChange, onAlbumClick, onArtistClick, onTrackClick, onBack, }: PlaylistInfoProps) {
    ...
    const localCollection = useLocalCollection({
        collectionImageUrl: playlistInfo.cover,
        collectionKey: `playlist:${playlistFolderName}`,
        collectionSubtitle: playlistInfo.owner.display_name,
              ...
              <div className="flex gap-2 flex-wrap">
                {hasLocalPlayback ? (<>
                    <Button onClick={() => void localCollection.playCollection()} disabled={localCollection.isCheckingFiles || localCollection.playableTracks.length === 0}>
                      ...
                      {localCollection.isCurrentCollectionActive && localCollection.isPlaying ? "Pause Playlist" : localCollection.allTracksDownloaded ? "Play Playlist" : "Play Downloaded"}
                    </Button>
